...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "Pass_Table";
    private static final String COL1 = "ID";
    private static final String COL2 = "titl";
    private static final String COL3 = "web";
    private static final String COL4 = "name";
    private static final String COL5 = "pass";
